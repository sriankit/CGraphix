...
Matrix4x4 theMatrix;
float initial[8][3]= {{80,80,-100},{180,80,-100},{180,180,-100},{80,180,-100},
...
void TransformPoints(void) {
    ...
    for(k=0 ; k<8 ; k++)
        for (i=0 ; i<3 ; i++)
            ptsFin[k][i] = theMatrix[i][0]*initial[k][0] + theMatrix[i][1]*initial[k][1]
                           + theMatrix[i][2]*initial[k][2] + theMatrix[i][3];
// Realign above line while execution
}
void Axes(void) {
...
int main (int argc, char *argv) {
    ...
    init ();
    printf("   **** WELCOME TO ILLUSTRATION OF BASIC TRANSFORMATIONS IN 3-DIMENSIONS ****\n\nEnter your choice number:\n1.Translation\n2.Scaling\n3.Rotation\n4.Reflection\n=>");
    scanf("%d",&choice);
    switch(choice) {
    case 1:
